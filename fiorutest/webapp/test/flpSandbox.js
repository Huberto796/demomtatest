		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commxgsfiorutest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commxgsfiorutest-display": {
								"semanticObject": "commxgsfiorutest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mx.gs.fiorutest",
									"url": sap.ui.require.toUrl("com/mx/gs/fiorutest")
								}
							}
						}
					}
